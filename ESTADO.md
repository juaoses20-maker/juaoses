...
- [~] **Stripe** (cobro) — código LISTO 2026-09-14, faltan las claves para activarlo:
  ...
  - Verificado por el agente: tsc ✓ build ✓ eslint ✓ (sin las claves puestas, el checkout/webhook fallarían en tiempo de uso — es esperado hasta el paso 2-4 de arriba).
